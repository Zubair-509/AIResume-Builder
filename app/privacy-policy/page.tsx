...
export default function PrivacyPolicyPage() {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-gray-900">
      ...
      {/* Header */}
      <section className="pt-24 pb-12 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-purple-900/20 relative overflow-hidden">
