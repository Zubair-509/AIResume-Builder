          ...
          >
            ...
            <div id="cookies" className="scroll-mt-24">
              ...
              <div className="pl-9">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Your Cookie Choices</h3>
                <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <div id="contact" className="scroll-mt-24">
              ...
              <div className="pl-9">
                ...
                <ul className="list-none mb-6 text-gray-700 dark:text-gray-300 space-y-2">
                  <li><strong>Email:</strong> <a href="mailto:privacy@snapcv.com" className="text-blue-600 hover:underline">privacy@snapcv.com</a></li>
                  <li><strong>Mail:</strong> SnapCV Privacy Team, 123 Innovation Way, San Francisco, CA 94107, United States</li>
